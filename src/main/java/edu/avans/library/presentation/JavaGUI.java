...
public final class JavaGUI {
    ...
    public static int current_image_height;
    public static int new_image_heigth;
    public static int center_panel_width;
    public static int center_panel_height;
    public static int items_xres_value_int;
    public static int items_yres_value_int;
    public static int set_grid_x;
    public static int set_grid_y;
    public static int new_panel_width;
    public static int new_panel_height;
    public static int current_blancoimage_width;
    public static int current_blancoimage_height;
    public static int new_blancoimage_width;
